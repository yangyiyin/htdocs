...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="shuijun_save.php?action=rec" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
	     ...
	     <tr>
		  ...
		  <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag" onchange=setprice(this.value) name="flag"> <OPTION selected value=0 >未处理</OPTION> <OPTION value=1 <?php echo "selected";?>>处理中</OPTION></SELECT></td>
          </tr>
        </table>
