	        ...
	        <td align="left" bgcolor="#FFFFFF"><!--?php echo $viplx;?--><?php
				...
				switch($flag)
				{
				 ...
				 echo "<input type=radio name=flag value=1 checked=checked />核心代理
				       <input type=radio name=flag value=2>媒介主
					   <input type=radio name=flag value=3>广告主";
				 break;
				    
				 case "2":
				 echo "<input type=radio name=flag value=1>核心代理
				       <input type=radio name=flag value=2  checked=checked/>媒介主
					   <input type=radio name=flag value=3 >广告主";
			     break;
				 ...
				 echo "<input type=radio name=flag value=1>核心代理
				       <input type=radio name=flag value=2>媒介主
					   <input type=radio name=flag value=3 checked=checked/>广告主";
				 break;
				}
				?></td>
          </tr>
