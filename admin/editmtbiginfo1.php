...
?>
<form id="form1" name="form1" method="post" action="savemtbiginfo.php?action=shmt&ID=<?php echo $ID;?>&titleID=<?php echo $titleID;?>" onSubmit="return CheckForm();">
  <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#e2e2e2" style="margin-bottom:8px">
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  <td>
	    ...
	    <INPUT   value='1'  type="radio" name="typefl" <?php if($rsN["typefl"]==1) {echo "CHECKED";}?>>PC端网媒
	  　<INPUT  value='2' type="radio" name="typefl" <?php if($rsN["typefl"]==2) {echo "CHECKED";}?>>自媒体APP
	 <INPUT   value='3'  type="radio" name="typefl" <?php if($rsN["typefl"]==3) {echo "CHECKED";}?>>微信公众号
	  　<INPUT  value='4' type="radio" name="typefl" <?php if($rsN["typefl"]==4) {echo "CHECKED";}?>>新浪微博
...
if( isset($_GET['class_id']) ){//返回要编辑的媒体所属的二级分类
...
<?php } ?>
	...
	<tr bgcolor="#FFFFFF">
      ...
      <td width="83%"><input name="tela" type="text" id="tela" value="<?php echo $rsN["VipUser"];?>" size="60" /></td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><select name="linkurl" size="1" id="linkurl">
          <option value="非新闻源" <?if($rsN["linkurl"]=="非新闻源"){echo "selected";}?>>非新闻源</option>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td><select name="xinwenyuan" size="1" id="xinwenyuan">
          <option value="" <?if($rsN["xinwenyuan"]==""){echo "selected";}?>>非新闻源</option>
  ...
  <tr bgcolor="#FFFFFF">
	...
	<tr bgcolor="#FFFFFF">
      ...
      <td><label>
        <input name="sccprice" type="text" id="sccprice" value="<?php echo $rsN["sccprice"];?>" size="13" />元
      </label></td>
    </tr>
...
<div  id='editora' style="display:none;"><?php echo $rsN["content"];?></div>
	...
	<tr bgcolor="#FFFFFF">
      ...
      <td>
	  <script id="aeditor" name="neirong" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editorb' style="display:none;"><?php echo $rsN["neirong"];?></div>
</td>
    </tr>
	<tr bgcolor="#FFFFFF">
...
<option value="../images/stars5.gif" <?if($rsN["tj"]=="../images/stars5.gif"){echo "selected";}?>>5星推荐</option>
	...
	<tr bgcolor="#FFFFFF">
	  ...
	  if($rsN["sh"]<>1)
	  {
	  echo "<input name='sh' type='checkbox' id='sh' value='1' />";
	  }
	  else
	  {
	  echo "<input name='sh' type='checkbox' id='sh' value='1' checked='checked' />";
	  }
	  ?>
      是</td>
	  </tr>
