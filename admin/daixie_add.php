...
5、软文案例：&lt;br /&gt;若能提供一篇您认为不错的软文链接给我们，对我们的写作方向很有参考作用，写出的文章也能比较达到您预期的要求。&lt;BR /&gt;</div>
  ...
  <TR>
    ...
    <TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" 
    bgColor=#ffffff align=left><SELECT id="pianshu" lang=require onchange=setprice(this.value) name="pianshu" value=''> <OPTION selected value=1>请选择</OPTION> <OPTION value=2>普通文章100元/篇</OPTION> <OPTION value=3>优秀文章180元/篇</OPTION> <OPTION value=4>高级写手300元/篇</OPTION> <OPTION value=5>资深记者360元/篇</OPTION></SELECT></TD></TR>
  <TR>
    <TD bgColor=#ffffff height=30>
      <DIV align=center>金额</DIV></TD>
    <TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" 
    bgColor=#ffffff align=left>
	<INPUT style="COLOR: rgb(255,0,0)" id="jiage"  class=txt value='0' readOnly size=8 name="jiage"> 元 <SPAN id="ye"></SPAN><!--INPUT 
      id="dingdan" value="201308121116273426" type="hidden" name="dingdan"--><INPUT  id="yuer" value="<?php echo $yue;?>" type="hidden" name="yuer"></TD></TR>
  <TR>
