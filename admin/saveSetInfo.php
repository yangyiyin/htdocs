 ...
 else
 {
  ...
  switch($action)
  {
   case "add":
	   ...
	   break;
   case "save":
	   $sql="update webinfo set webname='".$_REQUEST["webname"]."',enwebname='".$_REQUEST["enwebname"]."',cname='".$_REQUEST["cname"]."',weburl='".$_REQUEST["weburl"]."',icp='".$_REQUEST["icp"]."',enicp='".$_REQUEST["enicp"]."',banquan='".$_REQUEST["banquan"]."',enbanquan='".$_REQUEST["enbanquan"]."',dianhua='".$_REQUEST["dianhua"]."',fax='".$_REQUEST["fax"]."',myemail='".$_REQUEST["myemail"]."',bgtel='".$_REQUEST["bgtel"]."',qq='".$_REQUEST["qq"]."',mob='".$_REQUEST["mob"]."',address='".$_REQUEST["address"]."',enaddress='".$_REQUEST["enaddress"]."',gcadd='".$_REQUEST["gcadd"]."',engcadd='".$_REQUEST["engcadd"]."',title='".$_REQUEST["title"]."',entitle='".$_REQUEST["entitle"]."',keyword='".$_REQUEST["keyword"]."',enkeyword='".$_REQUEST["enkeyword"]."',descr='".$_REQUEST["descr"]."',endescr='".$_REQUEST["endescr"]."'";
	   mysql_db_query($dbname,$sql);
	   //mysql_select_db($dbname);
	   //$result=mysql_query($sql);
