...
<script>
    ...
    $(document).ready(function(){  
        ...
        ue.ready(function() {//编辑器初始化完成再赋值  
		 ...
		 var uea = UE.getEditor('aeditor');  
        var proinfoa=$("#editorb").text();  
          
        uea.ready(function() {//编辑器初始化完成再赋值  
            uea.setContent(proinfoa);  //赋值给UEditor  
        });  
...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="huiyuan_save.php?action=isok" onsubmit="return check()" style="display:" >
...
<div  id='editora' style="display:none;"><?php echo htmlspecialchars($rsN["content"]);?></div>
		 ...
		 <tr>
            ...
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;">
				...
				<script id="aeditor" name="reason" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editorb' style="display:none;"><?php echo htmlspecialchars($rsN["reason"]);?></div>
