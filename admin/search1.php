...
elseif($_GET["jg"]<>"" and $_GET["jg"]<>"all"){
	...
	switch($_GET["jg"])
		{
		 case "0":
		   $sql="select * from media_info where (scprice between 0 and 40) and sh=1 and nav_id=46 order by ID asc";
		   break;
		 case "1":
		   $sql="select * from media_info where (scprice between 41 and 70) and sh=1 and nav_id=46 order by ID asc";
		   break;
		 case "2":
		   $sql="select * from media_info where (scprice between 71 and 120) and sh=1 and nav_id=46 order by ID asc";
		   break;
		 case "3":
		   $sql="select * from media_info where scprice >120 and sh=1 and nav_id=46 order by ID asc";
		   break;
		 default:
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC" id="searchtr" style="font-size:13px">
  ...
  <tr>
    ...
    <th width="170" bgcolor="#CDD3EB"><div align="center"><strong>媒体名称</strong></div></th>
