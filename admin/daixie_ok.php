...
<TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#e2e2e2>
  ...
  <TR>
    ...
    bgColor=#ffffff align=left><?php echo $rsN["content"];?>
       </TD></TR>
  <!--TR>
    <TD bgColor=#ffffff height=30>
  ...
  <TR>
	...
	<script id="editor" name="encontent" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editora' style="display:none;"><?php echo $rsN["encontent"];?></div>
	</TD></TR>
  <TR>
    <TD bgColor=#ffffff height=30>
  ...
  <TR>
     <td height="30" bgcolor="#FFFFFF"><div align="center">是否交稿</div></td>
     <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="yn" name="yn"> <OPTION value=1 >是</OPTION> <OPTION value=0 <?php echo "selected";?>>否</OPTION></SELECT></td>
  </TR>
  <TR>
