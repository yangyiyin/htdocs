...
<TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#e2e2e2 style="font-size:12px">
  ...
  <TR>
    ...
    bgColor=#ffffff>
      <DIV class="alink" align=center><a href="vipinfo.php?ID=<?php echo $rs["ID"];?>">会员信息</a> <a href="vipcaiwu.php?ID=<?php echo $rs["ID"];?>">财务报表</a> <a href="setvippass.php?ID=<?php echo $rs["ID"];?>">修改密码</a> <a href="managevip.php?ID=<?php echo $rs["ID"];?>">权限</a> <a href="vipchongzhi.php?ID=<?php echo $rs["ID"];?>">充值</a></DIV></TD>
    <TD bgColor=#ffffff>
