...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="shuijun_save.php?action=ref" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2'>
	     ...
	     <tr>
	        ...
	        <td align="left" bgcolor="#FFFFFF" style="padding-left:10px;"><font color="#FF0000"><b><?php echo $rsN[price];?></b></font>元<input id="price" value="<?php echo $rsN["price"];?>" type="hidden" name="price" />
			<font color="blue"><!--第一步：填写标题、内容；点击下一步；第二步：选择要提交的网站，发布成功，等待回链。--></font>
            </td>
          </tr>
		  <tr>
            <td height="30" bgcolor="#FFFFFF"><div align="center">发布状态</div></td>
            <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="flag" onchange=setprice(this.value) name="flag"><OPTION value=3 <?php echo "selected";?>>已拒稿</OPTION></SELECT></td>
          </tr>
		  <tr>
