...
<TABLE cellSpacing=1 cellPadding=0 width="100%" bgColor=#e2e2e2>
  ...
  <TR>
	...
	<script id="editor" name="yijian" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editora' style="display:none;"><?php echo htmlspecialchars($rsN["encontent"]);?></div>
