...
<H6>代写确认</H6>
<DIV class=content>
<FORM id=form1 onsubmit="return check()" method=post name=form1 action="savedaixie.php?action=isok2">
...
<div  id='editora' style="display:none;"><?php echo htmlspecialchars($rsN["content"]);?></div>
  ...
  <TR>
	...
	<script id="aeditor" name="encontent" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editorb' style="display:none;"><?php echo $rsN["encontent"];?></div>
  ...
  <TR>
     <td height="30" bgcolor="#FFFFFF"><div align="center">确认稿件</div></td>
     <td align="left" bgcolor="#FFFFFF" style="padding:10px;"><SELECT id="yn" name="yn"> <OPTION value=0 >未确认</OPTION> <OPTION value=1 <?php echo "selected";?>>已确认</OPTION></SELECT></td>
  </TR>
  <TR>
