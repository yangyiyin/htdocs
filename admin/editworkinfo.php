...
<div class="col-2  col-auto" >
	<h6>提交工单</h6>
	<div class="content">
	  <form id="form1" name="form1" method="post" action="saveworkinfo.php?action=rec&ID=<?php echo $ID;?>" onsubmit="return check()">
	    <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2">
	      <tr>
	        ...
	        <td width="88%" align="left" bgcolor="#FFFFFF" style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px"><?php echo $rsN["title"];?></td>
          </tr>
	      <tr>
	...
	<script id="editor" name="recontent" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editora' style="display:none;">尊敬的客户：<BR>
			　　您反馈的问题，我们已收到，并正在处理中...请耐心等待我们的处理结果，谢谢！</div>
