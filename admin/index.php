...
<div class="header">
  ...
  <div class="rt-col rt-col1">
   <div class="log white cut_line"><div style="background-color:#920f08;border-radius:5px;width:auto;height:35px;line-height:35px;display:inline-block;padding-left:10px;"><img style="margin-right:10px;position:relative;top:6px;vertical-align: initial;" src="../img/houtai_lianxiren.png" width="15">您好！<?php echo $_COOKIE["AdminUser"];?><span>|</span>所属角色：<?php
		switch($_COOKIE["fg"])
		{
		 case "1":
		 echo "站长";
		...
		?><span>|</span><a href="../logouts.php">[退出]</a>&nbsp;&nbsp;&nbsp;</div> <br><a href="/" target="_blank" id="site_homepage">站点首页</a><span>|</span>企业QQ：<?php echo $qq;?> <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq;?>&site=在线客服&menu=yes"><img src="images/qqaol.png" alt="点我咨询"></a></div>
  ...
  <div class="col-auto">
    ...
    <ul class="nav white" id="top_menu">
      ...
      <li id="_M7" class="on top_menu"><a href="javascript:_M(7,'right.php')" hidefocus="true" style="outline:none;">后台首页</a></li>
