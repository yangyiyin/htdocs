...
?>
<form id="form1" name="form1" method="post" action="wyx_save.php?action=editmt&ID=<?php echo $ID;?>&titleID=<?php echo $titleID;?>" onSubmit="return CheckForm();">
...
<script language="javascript">
	function CheckForm()
	{
		...
		if (Number(document.form1.fans.value) < 0) {
			alert("粉丝数量不能为负数.");
			document.form1.fans.focus();
			return false;
		}
