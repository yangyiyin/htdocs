...
$ID=$_REQUEST["ID"];
$sqlN="select * from qunfa_info where ID=".$ID."";
...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="qunfa_save.php?action=isok" onsubmit="return check()" style="display:" >
...
function mt_search(){
	$.get("qunfa_search.php?a=mt_search",{
...
function mt_search3(id){
	$.get("qunfa_search.php?a=mt_searchall",{
		"jg":"all"
	}
	,function(data){
		$("#s_meti").html(data);
