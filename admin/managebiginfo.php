...
<table style="MARGIN-TOP: 5px; BORDER-COLLAPSE: collapse; MARGIN-BOTTOM: 5px; HEIGHT: 35px" border=1 cellSpacing=1 borderColor=#c9d3e9 cellPadding=0 width="98%" align=center>
  <tr>
	...
	<form id="myform2" name="myform1" method="post" action="managebiginfo.php?titleID=<?php echo $titleID;?>" onsubmit="return checkSo();">
...
<table border=0 cellSpacing=0 cellPadding=0 width="98%" align=center style="font-size:12px">
  <tr bgColor=#7691c7>
    <td height="49" bgcolor="#FFFFFF"><form id="myform" name="myform" method="post" action="savebiginfo.php?action=del&amp;titleID=<?php echo $titleID;?>">
		...
		?>
			  ...
			  ?>
                  <tr align="center" onmouseover="this.bgColor='#FBDFCC';" onmouseout="this.bgColor='#FFFFFF';" height=25>
                    ...
                    <td style="padding-left:15px"><a target='_blank' href='/news/newsinfo.php?ID=<?php echo $rs["ID"];?>'><?php echo $newsOB->utfSubstr($rs["title"],0,93);?></a></td>
                    <td align="center"><?php
				  ...
				  ?>                    </td>
					...
					<a href="editbiginfo.php?ID=<?php echo $rs["ID"];?>&amp;class_id=<?php echo $rs["class_id"];?>&amp;titleID=<?php echo $titleID;?>">修改</a></div></td>
