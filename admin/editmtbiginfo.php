...
?>
<form id="form1" name="form1" method="post" action="savemtbiginfo.php?action=edit&ID=<?php echo $ID;?>&titleID=<?php echo $titleID;?>" onSubmit="return CheckForm();">
...
<?php } ?>
	...
	<tr bgcolor="#FFFFFF">
      ...
      <td width="83%"><input name="meijie" type="text" id="meijie" value="<?php echo $rsN["VipUser"];?>" size="20" /></td>
    </tr>
	<tr bgcolor="#FFFFFF">
      <td width="17%" align="right">联系编辑：</td>
      <td width="83%"><input name="tela" type="text" id="tela" value="<?php echo $rsN["tela"];?>" size="60" /></td>
    </tr>
