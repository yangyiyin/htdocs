...
<H6>财务管理（会员：<b style='color:#2a8104'><?php echo $VipUser;?></b>　余额：<b style='color:#FF0000'><?php echo $yue;?></b>元）</H6>
<DIV class=content>
<form id="myform" name="myform" method="post" action="savecaiwu.php?action=del&amp;ID=<?php echo $ID;?>">
	...
	　<table width="100%" border="0" cellspacing="0" cellpadding="2" style="font-size:12px">
            <tr>
                <td width="87%" height="35" align="center"><DIV class=pager><?php
					  ...
					  {
					  $Prv=$Page-1;
					  echo "<a href='vipcaiwu.php?ID=".$ID."'>首页</a>&nbsp;&nbsp;";
					  echo "<a href=vipcaiwu.php?Page=".$Prv."&ID=".$ID.">上一页</a>&nbsp;&nbsp;";
					  }
					  else
					  {
					   echo "首页&nbsp;&nbsp;";
					...
					echo $str;
					  ...
					  $NtPage=$Page+1;
					  $EdPage=$CountPage;
					  echo "<a href=vipcaiwu.php?Page=".$NtPage."&ID=".$ID.">下一页</a>&nbsp;&nbsp;";
					  echo "<a href=vipcaiwu.php?Page=".$EdPage."&ID=".$ID.">尾页</a>&nbsp;&nbsp;";
					  }
					  else
					  {
					   echo "下一页&nbsp;&nbsp;";
