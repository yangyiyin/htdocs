...
<head>
<TITLE>新闻动态_<?php echo $webname;?></TITLE>
    ...
    <div id="page_left">
        ...
        <div id="post_list_box" class="border_gray">
			...
			?>
                                    ...
                                    <div class="post">
                        <div class="post_left">
                            <a href="../news/newsinfo.php?ID=<?php echo $rs["ID"];?>" target="_blank" title="<?php echo $newsOB->utfSubstr($rs["title"],0,100);?>"><img src="<?php if($rs["images"]==""){
												echo "/images/logo.png";
											}
											else{
												echo $rs["images"];
											}
											?>" alt="<?php echo $newsOB->utfSubstr($rs["title"],0,100);?>"></a>
                            <a href="../news/news.php?BigID=<?php echo $rs["class_id"];?>" target="_blank"><span class="post_type_salon" style="background-color:#ed0d0d"><?php echo $BigClass;?></span></a>
                        </div>
                        <div class="post_right">
                            ...
                            <p class="post_brief"><?php echo mb_substr(strip_tags($rs["content"]),0,65,'utf-8');?></p>
                        </div>
                    </div>
    ...
    <div id="page_right">
        <div id="post_label" class="right_box border_gray">
            ...
            <div class="right_box_content">
                <ul>
				<?php
					$sql1="select * from news_class where paixu<4 order by ID asc";
...
<a class="top_post_item day_best_post" target="_blank" href="../news/newsinfo.php?ID=<?php echo $rs2["ID"];?>" title="<?php echo $newsOB->utfSubstr($rs2["title"],0,100);?>" alt="<?php echo $newsOB->utfSubstr($rs2["title"],0,100);?>" style="display: block;">
                        <img src="<?php if($rs2["images"]==""){
												echo "/images/logo.png";
											}
											else{
												echo $rs2["images"];
