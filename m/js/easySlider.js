		...
		$.extend( Plugin.prototype, {
			...
			slideParameters: {
				...
				setAutoStatus: function(autoStatus) {
					...
					this.slideParameters.autoStatus = autoStatus;
				},
				getAutoStatus: function() {
					console.log(this.autoStatus);
					return this.slideParameters.autoStatus;
				},
				...
				clickRight: function() {
					...
					$(this.settings.controlsClass+" "+"li:last-child").click(
						function() {
							...
							_this.slideParameters.setAutoStatus.call(this, false);
						}
					);
				},
				clickLeft: 	function() {
			...
			animations: {
				...
				autoSlide: function() {
					...
					function slide() {
						// console.log(_this.slideParameters.getAutoStatus.call(_this));
