...
<section class="init-banner">
        ...
        <div class="text">
            <h3>解决方案</h3>            <p><small>打造个性化行业解决方案，为用户提供一站式的推广服务</small></p>        </div>
...
<?php
			...
			?>
				 ...
				 if ($fy=="yes")
				 {
								  ...
								  {
								  $Prv=$Page-1;
								  echo "<li class='paginate_button'><a href='../system/anli.php'>首页</a></li>";
								  echo "<li class='paginate_button'><a href='../system/anli.php?Page=".$Prv."'>上一页</a></li>";
								  }
								  else
								  {
								  ...
								  $NtPage=$Page+1;
								  $EdPage=$CountPage-1;
								  echo "<li class='paginate_button'><a href='../system/anli.php?Page=".$NtPage."'>下一页</a></li>";
								  echo "<li class='paginate_button'><a href='../system/anli.php?Page=".$EdPage."'>尾页</a></li>";
								  }
								  else
								  {
