...
<STYLE type=text/css>BODY {
	FONT-FAMILY: Microsoft Yahei, "微软雅黑", "宋体";  COLOR: #474747; FONT-SIZE: 14px;line-height:5x;
}
IMG {
...
#ruanwen_gg {
	BORDER-BOTTOM: #f0f0f0 1px solid; MARGIN-TOP: 0px; BACKGROUND: url(../images/ruanwen_bj.gif) #fafafa no-repeat center top; HEIGHT: 535px;line-height:25px;
}
.ruangwen_gg_main {
