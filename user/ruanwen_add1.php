...
<?php } ?>
<a href='rwgzy.php' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>
			</td>
		</tr>
...
<?php } ?>
<a href='rwgzy.php?fl=meiti' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>
			</td>
		</tr>
...
<?php } ?>
<a href='rwgzy.php?fl=diqu' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>
			</td>
		</tr>
