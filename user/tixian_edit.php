...
<H6>提现申请</H6>
<DIV class=content>
<FORM onsubmit="return check()" method=post name=alipayment action="savetixian.php?action=edit">
<TABLE cellSpacing=1 cellPadding=5 width="100%" bgColor=#e2e2e2 style="font-size:13px">
  ...
  <TR>
    <TD bgColor=#ffffff height=30 width="12%">
	  ...
	  <INPUT id="txid" value="<?php echo $ID;?>" type="hidden" name="txid">
  ...
  <TR>
    ...
    <TD bgColor=#ffffff width="88%" align=left>&nbsp;&nbsp;<INPUT style="WIDTH: 180px" id="accnumber" lang=require class=txt size=80 name="accnumber" value="<?php echo $rsN["accnumber"];?>"></TD></TR>
	<TR>
    <TD bgColor=#ffffff height=30 width="12%">
      <DIV align=center>
      <DIV align=center>账户名称</DIV></DIV></TD>
    <TD bgColor=#ffffff width="88%" align=left>&nbsp;&nbsp;<INPUT style="WIDTH: 180px" id="name" lang=require class=txt size=80 name="name" value="<?php echo $rsN["name"];?>"></TD></TR>
  <TR>
    <TD bgColor=#ffffff height=30>
      <DIV align=center>提现金额</DIV></TD>
    <TD bgColor=#ffffff align=left>&nbsp; <!--INPUT style="WIDTH: 80px" id="money" lang=require class=txt size=40 name="money" value=""--><?php echo $rsN["jine"];?> 元 </TD></TR>
  <TR>
