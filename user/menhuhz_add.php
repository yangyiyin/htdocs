...
<div id="main_frameid" class="pad-10 display" style="_margin-right:-12px;_width:98.9%;">
  <div class="col-2  col-auto" >
    ...
    <div class="content">
        <form id="form1" name="form1" method="post" action="menhuhz_save.php?action=add" onsubmit="return check()" style="display:" >
        <table width="100%" cellpadding="0" cellspacing="1" bgcolor="#e2e2e2" id='step2' style="font-size:12px">
	     ...
	     <tr>
			...
			<font color="blue">第一步：填写标题、内容；点击下一步；第二步：选择要提交的门户合作资源，发布成功，等待回链。</font>
            </td>
          </tr>
        </table>
        ...
        <table width="100%" border="0" cellpadding="0" style="border:1px solid #ccc;padding-bottom:5px;">
		  <TR>
			<TD style="PADDING-LEFT: 5px" bgColor=#f1f3f9>
			  <UL class=meitilist>
				<LI style="CURSOR: pointer" onclick=mt_search3()>门户合作类型-》</LI>
			  </UL>
			</TD>
		  </TR>
		  <TR>
			<TD style="PADDING-LEFT: 5px" bgColor=#ffffff>
			  <UL class=meitilist>
			  <?php
				$sqls="select * from media_class where BigID=51 order by paixu desc";
        ...
        <form name="form2" id='searchtrun' style="margin-bottom:20px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#e2e2e2" >
            <tr>
			  ...
			  <?php
				$sqlc="select * from media_class where BigID=51";
