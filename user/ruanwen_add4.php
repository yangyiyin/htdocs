...
<input type="hidden" name="typefl" id="typefl" value="4">
</div> 
...
<tr style="display:none;">
   ...
   <a href='rwgzy.php?fl=xlwb' class='button button-primary button-rounded button-small' target='_blank'>导出新浪微博价格表</a>
