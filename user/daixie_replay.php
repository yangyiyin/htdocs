    ...
    $(document).ready(function(){  
        ...
        uea.ready(function() {//编辑器初始化完成再赋值  
            uea.setContent(proinfoa);  //赋值给UEditor  
				 ...
				 var ueb = UE.getEditor('beditor');  
        var proinfob=$("#editorc").text();  
          
        ueb.ready(function() {//编辑器初始化完成再赋值  
            ueb.setContent(proinfob);  //赋值给UEditor  
        });  
...
<div  id='editorb' style="display:none;"><?php echo $rsN["encontent"];?></div>
  ...
  <TR>
    ...
    <TD style="PADDING-BOTTOM: 10px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; PADDING-TOP: 10px" 
    bgColor=#ffffff align=left>
	<script id="beditor" name="recontent" type="text/plain" style="width:85%;height:330px;"></script>
<div  id='editorc' style="display:none;"></div>
</TD></TR>
  <TR>
