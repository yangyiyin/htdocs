...
//-->
	...
	<a href="javascript:_M(8,'right.php')" hidefocus="true" style="outline:none;"><h4 class="f14"><span class="ico_shouye" title="展开与收缩"></span>后台首页</h4></a>
	
<a onclick="javascript:ShowFLT(1)" href="javascript:void(null)"><h3 class="f14"><span class="ico_gr switchs cu on" title="展开与收缩"></span>个人管理</h3></a>
<ul id="LM1">
<?php
if ($fg=="2"){?>
