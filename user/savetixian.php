...
else
{
  ...
  switch($action)
  {
   case "add":
	...
	$sql="insert into tixian (order_id,title,accnumber,jine,VipUser,data,name) values ('".$order_id."','".$title."','".$accnumber."',".$jine.",'".$VipUser."','".$data."','".$name."')";
  ...
  case "edit":
	...
	$ID=@$_REQUEST["txid"];
	$sql="update tixian set accnumber='".$accnumber."',name='".$name."' where ID=".$ID."";
	mysql_db_query($dbname,$sql);
