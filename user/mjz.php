...
//以下是要导出的数据
$sql="select order_id,title,weburl,medianame,price,data from ruanwen_info where owner='".$VipUser."' and flag=2 and yn=1 order by order_id desc";
...
$excel->getActiveSheet()->setTitle('订单列表'); //含义见下图
