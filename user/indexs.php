...
if($VipUser<>""){
	...
	echo "<script>alert('对不起！您没有访问权限。');location.href='../indexs.php';</script>";
}
?>
<html>
<head>
...
<style type="text/css">
.nextpage{position:fixed;background:#c73938;text-align:center;color:#fff;bottom:0px;margin:0px;left:0px;line-height:28px;width:100%;z-index:999;_width:100%;_position:absolute;font-size:14;expression(eval(document.documentElement.scrollTop+document.documentElement.clientHeight-this.offsetHeight-(parseInt(this.currentStyle.marginTop,20)||0)-(parseInt(this.currentStyle.marginBottom,20)||0)));}
#yincang{display:none;}
.houtai_zixun{background:url("../img/houtai_zixun_bg.png") center;text-align:center;color:#ffffff;line-height:31px;width:100px;height:31px;display:inline-block;box-sizing:border-box;padding-left:28px;
-moz-box-sizing: border-box;-webkit-box-sizing: border-box;-o-box-sizing: border-box;-ms-box-sizing: border-box;
}
.h10{height:10px;}
.index_tuichu{background-color:#fff;color:#b6b6b6;-webkit-border-radius: 50% 50%; width:12px;height:12px;line-height:12px; -moz-border-radius: 50% 50%;border-radius:50%;display:inline-block;text-align:center;}
</style>
<style type="text/css">
.objbody{overflow:hidden;position:relative;top:0px}.btns{background-color:#666;}.btns{position:absolute;top:116px;right:30px;z-index:1000;opacity:0.6;}.btns2{background-color:rgba(0,0,0,0.5);color:#fff;padding:2px;border-radius:3px;box-shadow:0px 0px 2px #333;padding:0px 6px;border:1px solid #ddd;}.btns:hover{opacity:1;}.btns h6{padding:4px;border-bottom:1px solid #666;text-shadow:0px 0px 2px #000;}.btns .pd4{padding-top:4px;border-top:1px solid #999;}.pd4 li{border-radius:0px 6spx 0px 6px;margin-top:2px;margin-bottom:3px;padding:2px 0px;}.btns .pd4 li span{padding:0px 6px;}.pd{padding:4px;}.ac{background-color:#333;color:#fff;}.hvs{background-color:#555;cursor:pointer;}.bg_btn{width:32px;height:32px;}
</style>
</head>
...
<div class="header">
  <div class="logo lf"><a href="indexs.php"><span class="invisible">内容管理系统</span></a></div>
 <div class="rt-col rt-col1">
   <div class="log white cut_line"><div style="background-color:#920f08;border-radius:5px;width:auto;height:35px;line-height:35px;display:inline-block;padding-left:10px;"><img style="margin-right:10px;position:relative;top:6px;vertical-align: initial;" src="../img/houtai_lianxiren.png" width="15">您好！<?php echo $_COOKIE["VipUser"];?><span>|</span>所属角色：<?php
		switch($_COOKIE["fg"])
		{
		 case "1":
		 echo "核心代理";
		...
		?><span>|</span><p class="index_tuichu">×</p><a href="../logouts.php">[退出]</a>&nbsp;&nbsp;&nbsp;</div></br> <a href="/" target="_blank" id="site_homepage">站点首页</a><span>|</span>企业QQ：<?php echo $qq;?> <a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $qq;?>&site=在线客服&menu=yes"><img src="images/qqaol.png" alt="点我咨询"></a></div>
  ...
  <div class="col-auto">
	...
	<?php if($_COOKIE["fg"]==2){?>
		<li id="_M2" class="top_menu"><a href="javascript:_M(2,'tixian.php')"  hidefocus="true" style="outline:none;">申请提现</a></li>
		
	<?php  }
	else{
	?>
		<li id="_M1" class="top_menu"><a href="javascript:_M(1,'ruanwen_add.php')" hidefocus="true" style="outline:none;">软文发布</a></li>
		<li id="_M3" class="top_menu"><a href="javascript:_M(3,'daixie_add.php')"  hidefocus="true" style="outline:none;">代写文章</a></li>
		
	<?php
	  }
	?>
      <li id="_M5" class="top_menu"><a href="javascript:_M(5,'info.php')"  hidefocus="true" style="outline:none;">个人信息</a></li>
      <li id="_M6" class="top_menu"><a href="javascript:_M(6,'work_add.php?titleID=ask')"  hidefocus="true" style="outline:none;">问题反馈</a></li>
      <?php if ($_COOKIE["fg"]<>2){?><li id="_M7" class="top_menu"><a href="javascript:_M(7,'chongzhi.php')"  hidefocus="true" style="outline:none;">在线充值</a></li><?php }?>
      <li id="_M8" class="on top_menu"><a href="javascript:_M(8,'right.php')" hidefocus="true" style="outline:none;">后台首页</a></li>
  ...
  <div class="col-auto mr8">
    ...
    <div class="col-1">
      <div class="content" style="position:relative; overflow:hidden">
        <iframe name="right" id="rightMain" src="right.php" frameborder="false" scrolling="auto" style="border:none; margin-bottom:10px" width="100%" height="auto" allowtransparency="true"></iframe> 
      </div>
    </div>
  </div>
</div> 
...
function _MP(menuid,targetUrl) {
	...
	switch(menuid)
	{
		...
		case 11:
			...
			break;
		case 12:
			$("#current_pos").html("媒介管理 > 添加媒介管理");
			break;
		case 13:
			$("#current_pos").html("反馈管理 > 问题反馈");
			break;
		case 14:
			$("#current_pos").html("反馈管理 > 反馈列表");
			break;
		case 15:
