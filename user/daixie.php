...
$sql="select * from daixie_info where VipUser='".$VipUser."' order by ID desc limit ".($List_Num*($Page-1)).",".$List_Num."";
...
<div class="col-2  col-auto" >
	...
	<div class="content">
	  ...
	  <?php
		...
		<TD bgColor=#ffffff>
		  <DIV align=center>代写标题</DIV></TD>
		<TD bgColor=#ffffff>
		  <DIV align=center width=5%>代写篇数</DIV></TD>
		<TD bgColor=#ffffff>
		  <DIV align=center width=10%>费用（元）</DIV></TD>
		<TD bgColor=#ffffff>
		  <DIV align=center width=10%>创建时间</DIV></TD>
		<TD bgColor=#ffffff>
		  <DIV align=center width=10%>当前状态</DIV></TD>
	...
	<?php }
	elseif($rs['flag']==2 and $rs['yn']==0){?>
		<A href="../dsinfo.php?ID=<?php echo $rs["ID"];?>" target="_blank">预览</A> <A href="daixie_ok.php?ID=<?php echo $rs["ID"];?>">确认</A> <A href="daixie_replay.php?ID=<?php echo $rs["ID"];?>">反馈</A>
	<?php }
	elseif($rs['flag']==3 and $rs['yn']==0){?>
		<A href="../dsinfo.php?ID=<?php echo $rs["ID"];?>" target="_blank">预览</A> <A href="daixie_ok.php?ID=<?php echo $rs["ID"];?>">确认</A> <A href="daixie_replay.php?ID=<?php echo $rs["ID"];?>">反馈</A>
	<?php }
