...
<FORM name=formbill onSubmit="return CheckForm();" action="../pay/Send.php" method=post>
<TABLE cellSpacing=1 cellPadding=5 width="100%" bgColor=#e2e2e2 style="font-size:13px">
  ...
  <TR>
    ...
    <TD bgColor=#ffffff align=left><IMG src="../images/chinabank.gif" width=160 height=57></TD></TR>
  <TR>
  ...
  <TR>
    <TD bgColor=#ffffff height=35 width="12%">
      <DIV align=center>
      <DIV align=center>订 单 号</DIV></DIV></TD>
    <TD bgColor=#ffffff width="88%" align=left>&nbsp;&nbsp;<?php echo $order_id; ?></TD></TR>
	<INPUT size=30 name=v_oid maxlength="200" value="<?php echo $order_id; ?>" type="hidden">
	<INPUT size=30 name=remark2 id=remark2 maxlength="200" value="会员充值" type="hidden">
	<INPUT size=30 name=WIDbody maxlength="200" value="" type="hidden">
  <TR>
    <TD bgColor=#ffffff height=35>
      <DIV align=center>充值金额</DIV></TD>
    <TD bgColor=#ffffff align=left>&nbsp; <INPUT maxLength=10 size=30 name=v_amount onFocus="if(Number(this.value)==0){this.value='';}" value="0.01" style="width:113"/>&nbsp; <span>如：112.21</span>
