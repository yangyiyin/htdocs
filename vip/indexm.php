...
switch($_GET["type"])
	{
	case "1":
	$list="<a class='on' href='?type=1'>新闻媒体</a><a  href='?type=2'>自媒体APP</a><a  href='?type=3'>微信公众号</a><a  href='?type=4'>新浪微博</a>";
	$dclink='rwgzy.php';
	$mtdl='综合门户网站';
	$dcmc='导出媒体资源表';
	$mtdltj='paixu>50';
	$typefl=1;
		break;
	case "2":
	$list="<a  href='?type=1'>新闻媒体</a><a class='on' href='?type=2'>自媒体APP</a><a  href='?type=3'>微信公众号</a><a  href='?type=4'>新浪微博</a>";
	...
	$typefl=2;
		break;
	case "3":
	$list="<a  href='?type=1'>新闻媒体</a><a  href='?type=2'>自媒体APP</a><a class='on' href='?type=3'>微信公众号</a><a  href='?type=4'>新浪微博</a>";
	$dclink='rwgzy.php?fl=zmt';
	$dcmc='导出自媒体资源表';
	$mtdl='客户端自媒体';
	$mtdltj='paixu<51';
	$typefl=3;
		break;
	case "4":
	$list="<a  href='?type=1'>新闻媒体</a><a  href='?type=2'>自媒体APP</a><a  href='?type=3'>微信公众号</a><a class='on' href='?type=4'>新浪微博</a>";
	$dclink='rwgzy.php?fl=zmt';
	$dcmc='导出自媒体资源表';
	$mtdl='客户端自媒体';
	$mtdltj='paixu<51';
...
<?php
 if($_GET["type"]==1 || $_GET["type"]==''){echo "<a href='rwgzy.php' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>";}
?>
...
<tr   <?php if($_GET["type"]==3||$_GET["type"]==4){echo "style='display:none'";}?>>
...
<?php } ?>
<?php
 if($_GET["type"]==1 || $_GET["type"]==''){echo "<a href='rwgzy.php?fl=meiti' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>";}elseif($_GET["type"]==2){echo "<a href='rwgzy.php?fl=zmt' class='button button-primary button-rounded button-small' target='_blank'>导出自媒体资源表</a>";}
?>
			</td>
		</tr>
...
<?php
 if($_GET["type"]==1 || $_GET["type"]==''){echo "<a href='rwgzy.php?fl=diqu' class='button button-primary button-rounded button-small' target='_blank'>按分类导出资源表</a>";}
?>
			</td>
		</tr>
...
<tr <?php if($_GET["type"]==3||$_GET["type"]==4){echo "style='display:none'";}?>>
    ...
    <a class="button button-pill button-tiny" onclick="mt_search4('网页收录')">网页收录</a>
		...
		<tr <?php if($_GET["type"]==1||$_GET["type"]==2||$_GET["type"]==""){echo "style='display:none'";}?>>
...
<?php if($_GET["type"]==1||$_GET["type"]==2||$_GET["type"]==""){
	echo "<a onclick='mt_search2(1)' class='button button-pill button-tinyn'>5-20元</a>	
    ...
    <a class='button button-pill button-tiny' onclick='mt_search2(3)'>50元以上</a>";
		...
		echo "<a class='button button-pill button-tiny' onclick='mt_search2(4)'>0-100元</a>
...
<?php
 ...
 if($_GET["type"]==3){echo "<a href='rwgzy.php?fl=wxgzh' class='button button-primary button-rounded button-small' target='_blank'>导出微信公众号价格表</a>";}
if($_GET["type"]==4){echo "<a href='rwgzy.php?fl=xlwb' class='button button-primary button-rounded button-small' target='_blank'>导出新浪微博价格表</a>";}
